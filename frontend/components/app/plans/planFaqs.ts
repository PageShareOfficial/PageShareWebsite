...
export const PLAN_FAQS: PlanFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Yearly is billed once for 12 months at a lower effective monthly rate. Analyst yearly equals about 25% discount versus paying monthly; Investor yearly equals about 20% discount. The large price on the card is the monthly equivalent; Stripe charges the annual total at checkout.',
  },
  {

"""Live Coinbase evaluate with zoom/search trace (manual).

Writes: tests/test_reports/08_PREDICTION_LIVE_EVALUATE_ZOOM_TRACE.md
Run from backend/:
  $env:PYTHONPATH = "."
  python tests/test_live_evaluate_zoom_trace.py
"""
...
pytestmark = pytest.mark.skip(
    reason="Manual live Coinbase script; run: python tests/test_live_evaluate_zoom_trace.py"
)

UTC = timezone.utc
REPORTS_DIR = Path(__file__).resolve().parent / "test_reports"
OUT_PATH = REPORTS_DIR / "08_PREDICTION_LIVE_EVALUATE_ZOOM_TRACE.md"
